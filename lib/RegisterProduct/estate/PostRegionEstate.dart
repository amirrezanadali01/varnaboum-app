...
import 'TypeEstate/PostBetweenTypeEstate.dart';

class PostRegionEstate extends StatefulWidget {
  PostRegionEstate({Key? key}) : super(key: key);

  @override
  State<PostRegionEstate> createState() => _PostRegionEstateState();
}

class _PostRegionEstateState extends State<PostRegionEstate> {
  late Future<List> regions;
  int _val = 0;
  int city = postProduct['city'];
      ...
      body: FutureBuilder<List>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              postProduct['region'] = snapshot.data![_val]['id'];
              print(postProduct['region']);
              return Padding(
