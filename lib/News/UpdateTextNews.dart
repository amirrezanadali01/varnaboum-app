...
class UpdateTextNews extends StatefulWidget {
  UpdateTextNews(
      {Key? key,
      required this.field,
      this.text,
  ...
  @override
  State<UpdateTextNews> createState() => _UpdateTextNewsState();
}

class _UpdateTextNewsState extends State<UpdateTextNews> {
  ...
  Future<void> UpdateText() async {
    ...
    var response = await _dio.put("$host/api/OfficeNewsUpdate/${widget.id}/",
        data: formdata);
