...
class RegisterRegion extends StatefulWidget {
  RegisterRegion({Key? key}) : super(key: key);

  @override
  State<RegisterRegion> createState() => _RegisterRegionState();
}

class _RegisterRegionState extends State<RegisterRegion> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          // Comment for change
          if (registerInformationShop['region'] != null) {
            Navigator.push(
                context,
                MaterialPageRoute(
      ...
      body: FutureBuilder<List>(
          ...
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              registerInformationShop['region'] =
                  snapshot.data![_val]['id'].toString();
