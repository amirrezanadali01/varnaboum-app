...
class UpdateProductTransportation extends StatefulWidget {
  UpdateProductTransportation(
      {Key? key,
      required this.field,
      required this.text,
      this.isNumber = false,
  ...
  @override
  State<UpdateProductTransportation> createState() =>
      _UpdateProductTransportationState();
}

class _UpdateProductTransportationState
    extends State<UpdateProductTransportation> {
  ...
  Future<void> UpdateText() async {
    ...
    var response = await _dio.put(
        "$host/api/TransportationProductsUpdate/${widget.id}",
        data: formdata);
